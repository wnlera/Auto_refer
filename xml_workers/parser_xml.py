...
def parse_file(file_name):
    ...
    for elem in citation_elem:
        ...
        for sentence in paragraph_sentences:
            ...
            link = (sentence_id, citation_number)
    ...
    for sentence_id, citation_number in citations_links:
    ...
    result_denorm_data["file_name"] = [file_name for _ in range(len(citations_links))]
...
if __name__ == "__main__":
    ...
    for file in tqdm(os.listdir(xml_dir)):
        file_result = parse_file(xml_dir + "/" + file)
